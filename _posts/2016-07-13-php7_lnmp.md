...
### 编译php7
```
首先安装各种库吧 如果不安装也没事的 linux系统很智能 安装软件的时候会提示并报错的 根据错误安装对应的库即可
...
<a href="https://github.com/james-rh/swoole_pushmsg_websocket" target="_blank">https://github.com/james-rh/swoole_pushmsg_websocket</a>
<a href="https://github.com/hsinlu/swoole-chatroom" target="_blank">https://github.com/hsinlu/swoole-chatroom</a>
```
...
应用案例
<a href="https://github.com/walkor/workerman-queue" target="_blank">https://github.com/walkor/workerman-queue</a>
<a href="https://github.com/walkor/gatewayworker" target="_blank">https://github.com/walkor/gatewayworker</a>
